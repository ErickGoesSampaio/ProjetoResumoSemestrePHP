<?php
// Startando sessão do calendário
session_start();
include 'topo.php';
echo "<br>";

/**
 * Esta pagina é a pagina de views do calendario
 * nela sera possivel vizualizar o dia de hoje e
 *  os dias futuros.
 * Tambês é possive vizualizar os eventos de cada dia
 * junto deles poderá realizar o crud desses eventos.
 */
?>
